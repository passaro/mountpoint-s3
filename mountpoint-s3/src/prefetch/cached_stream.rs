...
#[derive(Debug)]
pub struct CachedPartStream<Cache, Runtime> {
    cache: Arc<Cache>,
    runtime: Runtime,
}

impl<Cache, Runtime> CachedPartStream<Cache, Runtime> {
...
impl<Cache, Runtime> ObjectPartStream for CachedPartStream<Cache, Runtime>
where
    ...
    Runtime: Spawn,
{
        ...
        Client: ObjectClient + Clone + Send + Sync + 'static,
    {
        ...
        let request_task = {
            ...
            let inner = CachedPartStreamInner { client, cache };
...
mod tests {
    ...
    fn test_read_from_cache(
        ...
        let stream = CachedPartStream::new(runtime, cache);
