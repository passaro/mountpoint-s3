...
struct CachingPartComposer<'r, E: std::error::Error, Cache, Runtime: Spawn> {
...
impl<E, Cache, Runtime> CachingPartComposer<'_, E, Cache, Runtime>
where
    ...
    Runtime: Spawn,
{
    ...
    async fn update_cache(&self, block: ChecksummedBytes, block_index: u64, block_offset: u64, object_id: &ObjectId) {
