...
use super::{Fixture, expected_bytes, test_s3_client_for};
...
async fn misaligned_request_start_reads_correctly() {
    ...
    assert_eq!(
        &segs.to_contiguous()[..],
        &expected_bytes(offset, 64 * KIB as usize)[..],
...
async fn deeper_read_ahead_preserves_correctness() {
    for depth in [0usize, 1, 4] {
        ...
        while offset < fx.spec.size {
            ...
            assert_eq!(
                &segs.to_contiguous()[..],
                &expected_bytes(offset, 256 * KIB as usize)[..],
...
async fn reading_across_the_handover_is_seamless() {
    ...
    while offset < initial + 8 * read_size {
        ...
        assert_eq!(
            &segs.to_contiguous()[..],
            &expected_bytes(offset, read_size as usize)[..],
